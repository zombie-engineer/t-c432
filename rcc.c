...
#define RCC_CFGR_ADCPRE_DIV_2 0
#define RCC_CFGR_ADCPRE_DIV_4 1
#define RCC_CFGR_ADCPRE_DIV_6 2
#define RCC_CFGR_ADCPRE_DIV_8 3
...
void rcc_set_72mhz_usb(void)
{
   ...
   * ADCCLK = PCLK2 / ADCPRE = 72MHz / 6 = 12MHz
  ...
  reg32_modify_bits(RCC_CFGR, RCC_CFGR_ADCPRE_POS, RCC_CFGR_ADCPRE_WIDTH,
